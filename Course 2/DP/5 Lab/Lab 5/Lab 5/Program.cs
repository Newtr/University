...
namespace Lab_5
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                IWriter writer = new FileWriter(@"D:\Документы БГТУ\4.ПП\5 Lab\test2.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"D:\Документы БГТУ\4.ПП\5 Lab\test4.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"D:\Документы БГТУ\4.ПП\5 Lab\test12.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
                string? result = hash.Save("BBBBCCCCC");
            ...
            {
                IWriter writer = new FileWriter(@"D:\Документы БГТУ\4.ПП\5 Lab\test13.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
                string? result = hash.Save("BBBBCCCCC");
