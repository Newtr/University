namespace AllInformation
{
    ...
    public class Printer : System.ComponentModel.Component      //компонент
    {
    ...
    public class Interface_Software_Tool : System.ComponentModel.Container{}
    ...
    {
        private int count = 0;
        public void CountTextBox(Figure Fig)
        {
            count++;
            Console.WriteLine($"Count of textbox = {count}");
        }
    }

    public class MyControll : Controller
    {
