...
int main(int argc, char* argv[])
{
	try 
	{
		if (argc == 4) 
		{
			...
			LPCWSTR path1 = L"D:\\Документы БГТУ\\4.ОС\\5_Lab\\Lab_05\\x64\\Debug\\OS05_02x.exe";
			LPCWSTR path2 = L"D:\\Документы БГТУ\\4.ОС\\5_Lab\\Lab_05\\x64\\Debug\\OS05_02x.exe";
			...
			if (CreateProcess(path2, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE | intToProcessPriority(parm2), NULL, NULL, &si1, &pi1))
